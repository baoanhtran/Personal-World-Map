...
class PlanNewTripWindow(ctk.CTk):
    ...
    def __init__(self, user, country_destination):
        ...
        self.label2 = ctk.CTkLabel(self, text="Enter the departure date (DD-MM-YY format)", text_color='#354f52', fg_color= "#f5f6f9", corner_radius= 32,   font=("Arial", 11, "bold") ,height=2)
        ...
        self.label3 = ctk.CTkLabel(self, text="Enter the arrival date (DD-MM-YY format)", text_color='#354f52', fg_color= "#f5f6f9", corner_radius= 32,   font=("Arial", 11, "bold") ,height=2)
    ...
    def save_new_trip(self, event):
        ...
        add_new_trip(self.user, self.country_destination_id, date)
        messagebox("Save your new trip", "Your new trip was added !")
        self.destroy()
